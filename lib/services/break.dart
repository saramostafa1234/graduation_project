...
//       double y = size.height - (sin((x * 0.02) + waveOffset) * 50 + (size.height * (waveOffset / 100)));
//       path.lineTo(x, y);
//     }
//
...
class AnimatedWaveScreen extends StatefulWidget {
  ...
  AnimatedWaveScreen({required this.nextScreen});
...
class _AnimatedWaveScreenState extends State<AnimatedWaveScreen>
  ...
  void initState() {
    ...
    // الانتقال بعد انتهاء الأنيميشن إلى الشاشة الممررة كـ بارامتر

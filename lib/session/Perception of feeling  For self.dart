...
import 'package:myfinalpro/session/aisession.dart';

class Feeling2Screen extends StatelessWidget {
  const Feeling2Screen({Key? key}) : super(key: key);
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            "عندما حصلت على هدية، قد نشعر بالسعادة لأن الهدايا تجعلنا نشعر بالتقدير والفرح",
